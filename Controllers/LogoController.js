import logoSchema from "../Models/Logo.js";
...
export const getlogo = async (req, res) => {
  try {
    let data = await logoSchema.find();
    if(!data){
...
//     const data=await logoSchema.findById(id)
//     if (!data) {
...
//     const updatedData=await logoSchema.findByIdAndUpdate(id,req.body,{new:true});
